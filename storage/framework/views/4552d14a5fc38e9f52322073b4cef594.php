    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg p-6">
                ...
                <form action="<?php echo e(route('grupos_musculares.store')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Users\cesar\Downloads\tcc\tcc1web\resources\views/grupos_musculares/create.blade.php ENDPATH**/ ?>