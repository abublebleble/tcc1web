...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="form mx-auto max-w-md">
            <?php echo csrf_field(); ?>
            ...
            <span class="span">Não tem uma conta? <a href="<?php echo e(route('register')); ?>">Cadastrar</a></span>
        </form>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
