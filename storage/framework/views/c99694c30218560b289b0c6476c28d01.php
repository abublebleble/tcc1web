...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('logo', null, []); ?> 
            <img src="<?php echo e(asset('images/logosite.png')); ?>" alt="Logo" class="w-20 h-20 mx-auto">
         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>" class="form mx-auto max-w-md">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
                            <div class="ms-2">
                                <?php echo __('Eu concordo com os :terms_of_service e :privacy_policy', [
...
<?php endif; ?>
            ...
            <span class="span">Já tem uma conta? <a href="<?php echo e(route('login')); ?>">Entrar</a></span>
        </form>
     <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH D:\Users\cesar\Downloads\tcc\tcc1web\resources\views/auth/register.blade.php ENDPATH**/ ?>