    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-lg rounded-lg p-6">
                <h1 class="text-2xl font-semibold text-gray-800 mb-6">Criar Novo Exercício</h1>
                ...
                <form action="<?php echo e(route('exercicios.store')); ?>" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <textarea id="descricao" name="descricao" rows="4" 
                                  class="w-full border border-gray-300 rounded-lg p-3 text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition"></textarea>
                    </div>
...
<?php /**PATH D:\Users\cesar\Downloads\tcc\tcc1web\resources\views/exercicios/create.blade.php ENDPATH**/ ?>